...
extern int z_impl_fuel_gauge_get_prop(const struct device * dev, struct fuel_gauge_property * props, size_t props_len);

__pinned_func
static inline int fuel_gauge_get_prop(const struct device * dev, struct fuel_gauge_property * props, size_t props_len)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		union { uintptr_t x; const struct device * val; } parm0 = { .val = dev };
		union { uintptr_t x; struct fuel_gauge_property * val; } parm1 = { .val = props };
...
extern int z_impl_fuel_gauge_set_prop(const struct device * dev, struct fuel_gauge_property * props, size_t props_len);

__pinned_func
static inline int fuel_gauge_set_prop(const struct device * dev, struct fuel_gauge_property * props, size_t props_len)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		union { uintptr_t x; const struct device * val; } parm0 = { .val = dev };
...
extern int z_impl_fuel_gauge_get_buffer_prop(const struct device * dev, struct fuel_gauge_buffer_property * prop, void * dst, size_t dst_len);

__pinned_func
static inline int fuel_gauge_get_buffer_prop(const struct device * dev, struct fuel_gauge_buffer_property * prop, void * dst, size_t dst_len)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		union { uintptr_t x; const struct device * val; } parm0 = { .val = dev };
		union { uintptr_t x; struct fuel_gauge_buffer_property * val; } parm1 = { .val = prop };
